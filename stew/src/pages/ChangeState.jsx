...
const ChangeState = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put('http://localhost:5000/updateState', formData, {
        headers: {
  ...
  return (
    <Wrapper>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        />
        <ProfileImageWrapper>
          <ProfileImage src={profileImage} alt="Profile" onClick={() => document.getElementById('profileImageInput').click()} />
          <ProfileImageInput
      ...
      {showEmojiSelector && <SelectStateImoji onClose={() => setShowEmojiSelector(false)} onSelect={handleSelectEmoji} />}
    </Wrapper>
  );
};
